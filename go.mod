...
require (
	...
	github.com/openziti/channel v1.0.2 // indirect
	github.com/openziti/foundation/v2 v2.0.4 // indirect
	github.com/openziti/identity v1.0.11 // indirect
	github.com/openziti/metrics v1.0.7 // indirect
	github.com/openziti/transport/v2 v2.0.28 // indirect
